  ...
  >
    ...
    <div className="flex flex-col gap-[60px]" style={{ flex: '1 1 520px', minWidth: '320px' }}>
      <div className="flex flex-col gap-5">
        <div
          className="self-start px-[18px] py-[14px] rounded-lg font-medium text-[18px] text-accent"
        ...
        <p className="m-0 font-normal text-[18px] leading-[1.5] text-body">
          A skilled frontend engineer with a passion for creating visually stunning and user-friendly
          websites. With a keen eye for detail and a commitment to excellence, I specialize in
          crafting online experiences that leave a lasting impression. From concept to launch, I
          collaborate closely with clients to bring their visions to life and ensure their digital
