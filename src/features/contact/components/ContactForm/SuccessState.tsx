...
export const SuccessState = ({ sentName, sentEmail, onReset }: Props) => (
  <div className="flex flex-col items-center text-center gap-5 py-10 px-2.5">
    ...
    <button
      type="button"
      onClick={onReset}
      className="mt-1.5 cursor-pointer px-6 py-3.5 rounded-lg border border-border-warm bg-card-raised font-medium text-[16px] text-muted hover:bg-card-alt transition-colors"
    >
